...
ObjectHandle ObjectPropertyRegister::FindObjectByName(std::string name) {
...
bool ObjectPropertyRegister::CopyComponentByName(std::string stringToHash,entt::entity from, entt::entity to) {
	return HelperFunctions::CallMetaFunction(stringToHash,"Copy Component",from,to).operator bool();
};